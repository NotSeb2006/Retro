        ...
        if (number == 0 && this.color) {
          ...
          if (this.color == 9) {
            ...
            <div class="license__state">San Andreas</div>
              ...
              <div class="license__row license__row--red license__row--pref">UNKNOWN</div>
              <div class="license__row license__row--red license__row--exp">2022</div>
              ...
              <div class="license__row license__row--red license__row--dob">${dob}</div>
              ...
              <div class="license__row license__row--small license__row--cref">${identifier}</div>
