...
function startRaceCreation(options)
  ...
  if raceType == nil or (raceType ~= "Point" and raceType ~= "Lap") then
    ::typecheck::
    racetype = KBInput("Is this a Point To Point race? (y/n)", "", 1)
...
function finishRaceCreation()
  ...
  TriggerServerEvent("mkr_racing:recieveCreateData", raceName, raceType, raceCategory, raceThumbnail, checkpoints)
