...
cfg.blackjackTables = {
    ...
    [4] = {
        dealerPos = vector3(1145.75,261.83,-51.84),
        dealerHeading = 222.39,
    ...
    [5] = {
        dealerPos = vector3(1143.91, 263.66, -51.84),
        dealerHeading = 45.41,
    ...
    [6] = {
        dealerPos = vector3(1134.35,267.28,-51.03),
        dealerHeading = 135.55,
        tablePos = vector3(1133.74, 266.6947, -52.04094),
        tableHeading = 315.01,
        distance = 1000.0,
        prop = "vw_prop_casino_blckjack_01b",
    ...
    [7] = {
        dealerPos = vector3(1149.30, 252.25,-51.03),
        dealerHeading = 129.92,
...
Citizen.CreateThread(function()
  Wait(10000)
  dealerPedSeeds = RPC.execute("np-blackjack:getDealerPedSeeds")
            ...
            if closestChair ~= nil and closestChairDist < 1.6 then
                if not timeoutHowToBlackjack then
                    if not uiIntShown then
                        local tableId = blackjack_func_368(closestChair)
                        local isHighRoller = false -- cfg.blackjackTables[tableId].highroller
...
RegisterUICallback("np-ui:blackjackHitStand", function(data, cb)
  ...
  elseif action == "surrender" then
    ...
    TriggerServerEvent("Blackjack:standBlackjack", true)
    declineCard()
