...
AddEventHandler("np-polyzone:enter", function(zone, data)
  ...
  inDeanWorld = true
  Citizen.CreateThread(function()
    while inDeanWorld do
      Citizen.Wait(1000)
      ClearAreaOfPeds(-1660.02, -1080.46, 13.1, 160.0, 1)
      ClearAreaOfVehicles(-1660.02, -1080.46, 13.1, 160.0, false, false, false, false, false)
    end
  end)
...
AddEventHandler("np-deanworld:findLostStuff", function(zone, data)
  ...
  TriggerEvent("DoLongHudText", "They handed you a note.")
  if hasCash then
...
AddEventHandler("np-deanworld:dropOffCases", function(zone, data)
  local charId = exports["isPed"]:isPed("cid")
  RPC.execute("np-deanworld:dropOffCases", charId)
end)

AddEventHandler("np-deanworld:buyAdministrationTicket", function(zone, data)
  TriggerEvent("DoLongHudText", "They look at you funny.", 2)
end)
