...
function Housing.func.loadInteractions(model,overWrite)
    ...
    for i=1,#Housing.interactionlist do
        ...
        if (name == "inventory_offset" and max.canHaveInventory) or (name == "charChanger_offset" and max.canHaveCharSelect) or (name == "crafting_offset" and (max.canHaveCrafting or (max.publicCrafting and isPublic))) or (name == "backdoor_offset_internal" and max.canHaveBackDoor) or (name == "internal_exit" and overWrite) then
