...
Housing.secondsPerJobCreated = 180 -- every 3 mins a job has the potential to be created
Housing.maxJobsAtAGivenTime = 8
...
Housing.robCat = {
    ...
    ["randomHousehold"] = {
        ...
        ["items"] = {
            ...
            {["name"] = "lockpick", ["chance"] = 8},
            {["name"] = "mobilephone", ["chance"] = 5},
            {["name"] = "muffin", ["chance"] = 30},
            {["name"] = "mugbeer", ["chance"] = 30},
            {["name"] = "rolexwatch", ["chance"] = 30},
            {["name"] = "pistolammo", ["chance"] = 10},
            {["name"] = "joint", ["chance"] = 20},
            {["name"] = "humantooth", ["chance"] = 5},
            {["name"] = "scrapmetal", ["chance"] = 20},
