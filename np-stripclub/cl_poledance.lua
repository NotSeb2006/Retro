...
Citizen.CreateThread(function()
    local insideStageArea = exports["np-polyzone"]:AddPolyZone("vanilla_unicorn_stage", {
...
function PoleSequence(pClosestPole, NPC)
  while IsUsingPole do
    ...
    while GetEntityAnimCurrentTime(NPC, firstDance[1], firstDance[2]) <
      0.999 and IsUsingPole do Citizen.Wait(0) end
...
function UsePole()
  ...
  IsUsingPole = true
  SetPedFlag(Player, 'isPoledancing', true)
...
function LeavePole()
  ...
  IsUsingPole = false
  SetPedFlag(Player, 'isPoledancing', false)
end
